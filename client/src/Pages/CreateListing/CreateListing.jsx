    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 sm:flex-row'>
        <div className='flex flex-col gap-4 flex-1'>
            ...
            className='border p-3 rounded-lg' id='name' max={62} min={10} required />
            ...
            <div className='flex flex-wrap gap-8'>
                <div className='flex items-center gap-1'>
                    <input type="number" id='bedrooms' min={1} max={20} className='p-3 border border-gray-300 rounded-lg'  onChange={handleChange}
                     value={formData.bedrooms} />
                    <p>Bedrooms</p>
                </div>
                <div className='flex items-center gap-1'>
                    <input type="number" id='bathrooms' min={1} max={20} className='p-3 border border-gray-300 rounded-lg'  onChange={handleChange}
                    value={formData.bathrooms} />
                    <p>Bathrooms</p>
                </div>
                <div className='flex items-center gap-1'>
                    <input type="number" id='regularPrice' min={1} max={10000000}   className='p-3 border border-gray-300 rounded-lg' onChange={handleChange}
